...
namespace DataAccess.Controllers
{
    ...
    {
        private readonly K64cntt2dbContext _context;

        public CtHoaDonsController(K64cntt2dbContext context)
        {
            _context = context;
        }
        ...
        {
            var k64cntt2dbContext = _context.CtHoaDons.Include(c => c.HoaDon).Include(c => c.SanPham);
            return View(await k64cntt2dbContext.ToListAsync());
        }
